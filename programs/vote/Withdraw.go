			...
			programBranch.Child(format.Instruction("Withdraw")).
				...
				ParentFunc(func(instructionBranch treeout.Branches) {
					...
					instructionBranch.Child("Accounts").ParentFunc(func(accountsBranch treeout.Branches) {
						accountsBranch.Child(format.Meta("                Vote", inst.AccountMetaSlice[0]))
						accountsBranch.Child(format.Meta("           Recipient", inst.AccountMetaSlice[1]))
						accountsBranch.Child(format.Meta("AuthorizedWithdrawer", inst.AccountMetaSlice[2]))
					})
				})
		})
}
